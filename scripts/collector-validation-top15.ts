...
// Deterministic: preserve Object.entries() order from SOURCE_PROFILES.
const TOP15: Source[] = sourcesFromProfiles.slice(0, 15)
...
async function validate() {
  ...
  for (const src of TOP15) {
    ...
    try {
      ...
      const candidates = links.filter((l) => l.score > 0).slice(0, 40)
  ...
  console.log('\n=== Collector Validation Report (Top15) ===')
  let parsedCount = 0
  ...
  console.log('Total opportunities parsed (Top15):', parsedCount)
}
